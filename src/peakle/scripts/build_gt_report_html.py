...
Usage: python -m peakle.scripts.build_gt_report_html <report_asset_dir> <bench_results.json>
...
ASSETS: Path | None = None  # the report asset dir; set by main() (uri/img read it)
